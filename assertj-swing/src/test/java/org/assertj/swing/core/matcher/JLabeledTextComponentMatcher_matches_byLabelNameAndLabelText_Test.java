 ...
 * @author Yvonne Wang
 */
public class JLabeledTextComponentMatcher_matches_byLabelNameAndLabelText_Test extends EDTSafeTestCase {
    ...
    public void should_Return_True_If_Name_And_Text_Are_Equal_To_Expected() {
        ...
        JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withLabelName("textField").andLabelText("Hello");
    ...
    public void should_Return_True_If_Name_Is_Equal_To_Expected_And_Text_Matches_Pattern() {
        JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withLabelName("textField").andLabelText("He.*");
        LabeledTextComponentWindow window = labeledTextField().withLabelName("textField").withLabelText("Hello").createNew(getClass());
        assertThat(matcher.matches(window.getTextField())).isTrue();
    }
}
