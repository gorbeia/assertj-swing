 ...
 * @author Yvonne Wang
 */
public class JLabeledTextComponentMatcher_matches_byTextAndShowing_Test extends SequentialEDTSafeTestCase {
  @Test
  public void should_Return_True_If_JTextComponent_Is_Showing_And_Text_Is_Equal_To_Expected() {
    ...
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withText("Hello").andShowing();
  ...
  public void should_Return_False_If_JTextComponent_Is_Showing_And_Text_Is_Not_Equal_To_Expected() {
    MyWindow window = MyWindow.createAndShow();
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withText("Bye").andShowing();
