 ...
 * @author Yvonne Wang
 */
public class JLabeledTextComponentMatcher_matches_any_Test extends EDTSafeTestCase {
  @Test
  public void should_Always_Return_True_When_Matching_Any_JTextComponent() {
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.any();
