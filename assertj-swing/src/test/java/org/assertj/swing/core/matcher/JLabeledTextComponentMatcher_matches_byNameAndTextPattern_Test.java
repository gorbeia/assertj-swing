 ...
 * @author Yvonne Wang
 */
public class JLabeledTextComponentMatcher_matches_byNameAndTextPattern_Test extends EDTSafeTestCase {
  @Test
  public void should_Return_True_If_Name_Is_Equal_To_Expected_And_Text_Matches_Pattern() {
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withName("textField").andText(Pattern.compile("He.*"));
