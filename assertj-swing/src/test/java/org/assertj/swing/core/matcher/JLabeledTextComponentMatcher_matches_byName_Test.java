 ...
 * @author Yvonne Wang
 */
public class JLabeledTextComponentMatcher_matches_byName_Test extends EDTSafeTestCase {
  @Test
  public void should_Return_True_If_Name_Is_Equal_To_Expected() {
    String name = "textField";
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withName(name);
  ...
  public void should_Return_False_If_Name_Is_Not_Equal_To_Expected() {
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withName("textField");
