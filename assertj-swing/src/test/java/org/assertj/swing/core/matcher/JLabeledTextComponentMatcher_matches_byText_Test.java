 ...
 * @author Yvonne Wang
 */
public class JLabeledTextComponentMatcher_matches_byText_Test extends EDTSafeTestCase {
  @Test
  public void should_Return_True_If_Text_Is_Equal_To_Expected() {
    String text = "Hello";
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withText(text);
  ...
  public void should_Return_True_If_Text_Matches_Pattern() {
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withText("Hello");
  ...
  public void should_Return_False_If_Text_Is_Not_Equal_To_Expected() {
    JLabeledTextComponentMatcher matcher = JLabeledTextComponentMatcher.withText("He.*");
    JTextField textField = textField().withText("Bye").createNew();
    assertThat(matcher.matches(textField)).isFalse();
  }
}
